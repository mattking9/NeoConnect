...
namespace NeoConnect.UnitTests
{
    ...
    public class ReportDataCollectionActionTests
    {
        ...
        private Mock<ILogger<ReportDataCollectionAction>> _mockLogger;
        ...
        public void Setup()
        {
            ...
            _mockLogger = new Mock<ILogger<ReportDataCollectionAction>>();
            ...
            _action = new ReportDataCollectionAction(_mockConfig.Object, _mockScopeFactory.Object, _mockLogger.Object, _mockEmailService.Object);
        }
